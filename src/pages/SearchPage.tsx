...
export function SearchPage() {
	...
	const hasSearchParams = departParam && arriveeParam;
	...
	useEffect(() => {
		refetch(buildUrl());
	}, [prixMax, placesMin, date, departParam, arriveeParam]);
							...
							<Card className="sticky top-24 border-border">
								<CardContent className="p-6 space-y-6">
									...
									<div>
										...
										<select
											disabled
											className="mt-2 h-10 w-full rounded-lg border border-input bg-background px-3 text-sm opacity-60 cursor-not-allowed"
										>
											<option>
												{departParam ||
													"Toutes les villes"}
